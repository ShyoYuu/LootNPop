...
#include "LNPPawnInputComponent.generated.h"
...
class LOOTNPOP_API ULNPPawnInputComponent : public UActorComponent, public IMoverInputProducerInterface
{
	GENERATED_BODY()

public:
	ULNPPawnInputComponent();
